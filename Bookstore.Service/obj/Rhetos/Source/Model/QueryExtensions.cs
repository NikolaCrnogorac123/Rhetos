namespace System.Linq
{
    ...
    public static class QueryExtensions
    {
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Bookstore.BookStoreGrid> ToSimple(this IQueryable<Common.Queryable.Bookstore_BookStoreGrid> query)
        {
            return query.Select(item => new Bookstore.BookStoreGrid
            {
                ID = item.ID,
